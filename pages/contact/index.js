...
export default function Contact() {
  return (
    <>
      <Navbar />
      <motion.div
        className={`${geistSans.className} ${geistMono.className} ${pixelFont.className} min-h-screen bg-black text-white flex flex-col items-center justify-center p-8`}
        initial={{ opacity: 0, y: 40 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ duration: 0.6 }}
      >
        <h1 className="text-4xl font-bold text-green-400 mb-10">Contact Me</h1>

        <div className="flex flex-col gap-8 text-lg w-full max-w-md">
          {/* GitHub */}
          <a
          ...
          {/* LinkedIn */}
          <a
            href="https://www.linkedin.com/in/wasiq-mansoor-35332927a"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-4 hover:text-green-400 transition"
          >
